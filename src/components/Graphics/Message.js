...
class Message extends Component {
  render() {
  	const {message, prevMessage, userMessage, theme, lastMessage} = this.props;
  	...
  	return(
  		<Fragment>
	  		...
	  		<div style={{display: 'flex', justifyContent: userMessage ? "flex-end" : "flex-start", alignItems: "center", width: "100%", marginTop: "0.15rem"}}>
	  		...
	  		{lastMessage && (<div style={{display: 'flex', justifyContent: "flex-end", alignItems: "center", width: "100%", marginTop: "0.1rem", marginBottom: "1rem"}}>
