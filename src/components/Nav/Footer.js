  ...
  render() {
  	...
  	return(
  		<Grid xs={12} container item direction="column" alignItems="center" style={{background: theme.background.main, zIndex: 100}}>
  			...
  			<div style={{zIndex: 99, maxWidth: maxWidth, width: small ? "calc(100% - 2rem)" : "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: small ? "1rem" : "0.4rem 0", height: "2rem"}}> 
	  			{/*
		      ...
		      */
		      ...
		      <span style={{fontWeight: 300, fontSize: "0.8rem", flex: 1, textAlign: "left", paddingTop: "0.2rem", color: theme.primary.main}}>APOLLOCARE 2020 &copy;</span>
	      </div>
  		</Grid>
  	);
  }
